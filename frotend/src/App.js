  ...
  return (
    <Router>
      <Suspense fallback={<CricketBallLoader />}>
        <Header />
        <Switch>
          <Route exact path="/" render={() => (<><Home /><Services /><Footer /></>)} />
          <Route exact path="/product/:id" render={() => (<><ProductDetails /><Services /><Footer /></>)} />
          <Route exact path="/products" render={() => (<><Products /><Services /><Footer /></>)} />
          <Route path="/products/:keyword" render={() => (<><Products /><Services /><Footer /></>)} />
          <Route exact path="/signup" render={() => (<><Signup /><Services /><Footer /></>)} />
          <Route exact path="/login" render={() => (<><Login /><Services /><Footer /></>)} />
          <Route exact path="/password/forgot" render={() => (<><ForgetPassword /><Services /><Footer /></>)} />
          <Route exact path="/password/reset/:token" render={() => (<><ResetPassword /><Services /><Footer /></>)} />
          <Route exact path="/cart" render={() => (<><Cart /><Services /><Footer /></>)} />
          <Route exact path="/policy/return" render={() => (<><ReturnPolicyPage /><Services /><Footer /></>)} />
          <Route exact path="/policy/Terms" render={() => (<><TermsUse /><Services /><Footer /></>)} />
          <Route exact path="/policy/privacy" render={() => (<><PrivacyPolicy /><Services /><Footer /></>)} />
          <Route exact path="/terms/conditions" render={() => (<><TermsAndConditions /><Services /><Footer /></>)} />
          <Route exact path="/contact" render={() => (<><ContactForm /><Footer /></>)} />
          <Route exact path="/about_us" render={() => (<><AboutUsPage /><Footer /></>)} />
          <Route exact path="/account" render={() => (<><PrivateRoute exact path="/account" component={Profile} /><Services /><Footer /></>)} />
          <Route exact path="/profile/update" render={() => (<><PrivateRoute exact path="/profile/update" component={UpdateProfile} /><Services /><Footer /></>)} />
          <Route exact path="/password/update" render={() => (<><PrivateRoute exact path="/password/update" component={UpdatePassword} /><Services /><Footer /></>)} />
          <Route exact path="/orders" render={() => (<><PrivateRoute exact path="/orders" component={MyOrder} /><Services /><Footer /></>)} />
          <Route exact path="/shipping" render={() => (<><PrivateRoute exact path="/shipping" component={Shipping} /><Services /><Footer /></>)} />
          <Route exact path="/order/confirm" render={() => (<><PrivateRoute exact path="/order/confirm" component={ConfirmOrder} /><Services /><Footer /></>)} />
          <Route exact path="/success" render={() => (<><PrivateRoute exact path="/success" component={OrderSuccess} /><Services /><Footer /></>)} />
